...
The first 14 slides move from why the benchmark is needed, to how public studies become mission-held-out tasks, to what feature layers the models see, and finally to the completed result spine with robustness, guardrails, limitations, biological hypotheses, and translation boundaries.

## Compression Decision

Default: Use B1 as slide 4 with B2 in notes; use B3 as slide 5 with B4 in notes; use feature-layer bridge as slide 6.

Expanded option: If the talk focus is methodology, split B2 and B4 into visible slides and shift the result spine later.

Risk: Over-expanding methods can delay the first result; over-compressing methods can make AUROC slides feel unearned.

## Slide Notes

### Slide 1: SpaceBio-Bench
...
Claim boundary: Schematic methods bridge, not a quantitative result figure.

Asset: output/premium_feature_layer_bridge_v0_4/feature_layer_bridge_v0_4_rendered_preview.png

### Slide 7: Tissue hierarchy

Headline: Cross-mission transfer is tissue-specific

Caption: Start the result core with the main tissue-dependence finding.

Claim boundary: Do not imply one tissue result generalizes to all tissues.

Asset: output/premium_slide_scenes/fig1_tissue_transfer_layered_scene.png

### Slide 8: Pathway rescue
...
Claim boundary: Do not claim pathway features always outperform gene-level models.

Asset: output/premium_slide_scenes/fig2_pathway_layered_scene.png
...
Claim boundary: Do not universalize foundation-model failure beyond tested settings.

Asset: output/premium_slide_scenes/fig3_model_tier_layered_scene.png
...
Claim boundary: Hardening and coverage evidence only; not a new leaderboard.

Asset: output/premium_core_result_slides/slide10_v4_hardening_v0_1/slide10_v4_hardening_rendered_preview.png

### Slide 11: Temporal and RRRM
...
Claim boundary: Recovery projection is descriptive; RRRM composition is underpowered.

Asset: output/premium_core_result_slides/slide11_temporal_rrrm_guardrails_v0_1/slide11_temporal_rrrm_guardrails_rendered_preview.png
...
Claim boundary: No universal absence-of-biology or universal model-failure claim.

Asset: output/premium_core_result_slides/slide12_negative_boundary_v0_1/slide12_negative_boundary_rendered_preview.png
...
Claim boundary: Interpretation and target triage only; no treatment or mechanism proof.

Asset: output/premium_core_result_slides/slide13_biological_interpretation_v0_1/slide13_biological_interpretation_rendered_preview.png
...
Claim boundary: No direct gene-transfer, clinical, or countermeasure claim.

Asset: output/premium_core_result_slides/slide14_human_translation_ladder_v0_1/slide14_human_translation_ladder_rendered_preview.png
