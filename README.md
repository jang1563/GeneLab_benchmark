...
| v8 extension | Incubating translational extension | Reproducibility hardening and artifact split | [v8 beta plan](docs/V8_BETA_RELEASE_PLAN_2026_05_10.md) |
...
| v9 extension lanes | Diagnostic or draft lanes | Single-cell, organoid, multispecies, and stressor task design | [v9 README](v9/README.md) |
...
v8/                    Incubating translational extension and release hardening
v9/                    Public-bulk alpha scaffold plus extension-lane drafts
spacebio_bench/        v9 package helpers, schemas, metrics, and manifests
...
- **v8**: incubating translational extension.
- **v9 public bulk**: metadata-only public bulk alpha.
- **v9 extension lanes**: diagnostic or draft until a lane-specific release
  promotes them.
