...
| Current HPC bundle records which raw analog count/sample-table caches are present or missing before full rerun. | `raw_cache_audit.json` | `v8/decompose/raw_cache_audit.py` | hpc_validated audit; full rerun blocked until missing caches are restored |
