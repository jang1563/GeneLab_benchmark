#!/usr/bin/env python3
"""Build strict visual QA crops for the transfer-matrix explainer asset."""
...
SOURCE = ASSET_DIR / "transfer_matrix_behind_ranking_premium.png"
...
def write_contact_sheet(crops: list[dict[str, object]], directory: Path, sheet_name: str) -> Path:
    ...
    for crop in crops:
        name = str(crop["name"])
        image = Image.open(directory / f"transfer_matrix_{name}.png")
...
def crop_set(target_dir: Path, specs: list[dict[str, object]], sheet_name: str) -> Path:
    ...
    for spec in specs:
        ...
        out = target_dir / f"transfer_matrix_{name}.png"
    ...
    (target_dir / "transfer_matrix_crop_manifest.json").write_text(
...
def main() -> None:
    qa_specs = [
        ...
        {"name": "02_matrix_grammar", "box": (130, 330, 1050, 1820)},
        {"name": "03_pair_spread_panel", "box": (1085, 330, 2840, 1820)},
        {"name": "04_insight_panel", "box": (2875, 330, 3710, 1820)},
    ...
    strict_specs = [
        ...
        {"name": "03_thymus_matrix", "box": (170, 560, 740, 1000)},
        {"name": "04_liver_matrix", "box": (160, 1060, 810, 1585)},
        {"name": "05_pair_spread_header_axis", "box": (1120, 360, 2820, 650)},
        {"name": "06_pair_spread_top_rows", "box": (1120, 610, 2820, 1130)},
        {"name": "07_pair_spread_bottom_rows", "box": (1120, 1085, 2820, 1655)},
        {"name": "08_pair_spread_legend", "box": (1120, 1620, 2820, 1790)},
        {"name": "09_insight_cards", "box": (2920, 560, 3670, 1460)},
        {"name": "10_slide_role", "box": (2920, 1485, 3670, 1790)},
        {"name": "11_footer_source", "box": (150, 1880, 3690, 2045)},
    ]
    qa_sheet = crop_set(QA_DIR, qa_specs, "transfer_matrix_qa_crop_contact_sheet.png")
    strict_sheet = crop_set(STRICT_DIR, strict_specs, "transfer_matrix_STRICT_QA_contact_sheet.png")
