#!/usr/bin/env python3
"""Build visual QA crops for slide 44 v8 pillars asset."""
...
SOURCE = ASSET_DIR / "v8_has_four_incubator_pillars_premium.png"
...
def write_contact_sheet(crops: list[dict[str, object]], directory: Path, sheet_name: str) -> Path:
    ...
    for crop in crops:
        name = str(crop["name"])
        image = Image.open(directory / f"v8_pillars_{name}.png")
...
def crop_set(target_dir: Path, specs: list[dict[str, object]], sheet_name: str) -> Path:
    ...
    for spec in specs:
        ...
        out = target_dir / f"v8_pillars_{name}.png"
    ...
    (target_dir / "v8_pillars_crop_manifest.json").write_text(
...
def main() -> None:
    qa_specs = [
        ...
        {"name": "03_all_pillars", "box": (120, 610, 3720, 1658)},
        {"name": "04_reader_strip", "box": (120, 1710, 3720, 1858)},
        {"name": "05_footer_scope", "box": (120, 1910, 3720, 2076)},
    ...
    strict_specs = [
        ...
        {"name": "03_bridge_card", "box": (120, 610, 993, 1658)},
        {"name": "04_decompose_card", "box": (1029, 610, 1902, 1658)},
        {"name": "05_intervene_card", "box": (1938, 610, 2811, 1658)},
        {"name": "06_causal_card", "box": (2847, 610, 3720, 1658)},
        {"name": "07_visual_row_top", "box": (120, 835, 3720, 1185)},
        {"name": "08_text_rows_bottom", "box": (120, 1190, 3720, 1658)},
        {"name": "09_reader_nodes", "box": (850, 1710, 3720, 1858)},
        {"name": "10_footer", "box": (120, 1910, 3720, 2076)},
    ]
    qa_sheet = crop_set(QA_DIR, qa_specs, "v8_pillars_qa_crop_contact_sheet.png")
    strict_sheet = crop_set(STRICT_DIR, strict_specs, "v8_pillars_STRICT_QA_contact_sheet.png")
