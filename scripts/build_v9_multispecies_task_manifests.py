#!/usr/bin/env python3
"""Build draft v9 multispecies species-native task manifests and index."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help="Output directory for draft multispecies task manifests.",
    )
    parser.add_argument(
        "--index-csv",
        default="v9/multispecies/task_manifest_index.draft.csv",
        help="Output CSV path for the draft multispecies task index.",
    )
    parser.add_argument(
        "--index-json",
        default="v9/multispecies/task_manifest_index.draft.json",
        help="Output JSON path for the draft multispecies task index.",
    )
...
def main() -> None:
    ...
    manifest_paths = [
        write_task_manifest(manifest, output_dir / f"{manifest['task_id']}.json")
