...
SLIDES = [
    ...
    },
    {
        ...
        "role": "positioning",
        "status": "needs positioning matrix",
        "tone": "teal",
...
def build() -> dict[str, str]:
    ...
    qa = {
        ...
        "manual_review": {
            "visual_review_status": "pass: assembly board and grayscale QA inspected after opening-card text wrap revision",
            ...
            "production_decision": "slides 1-3 need new visuals; slides 4-14 can proceed from existing premium assets",
