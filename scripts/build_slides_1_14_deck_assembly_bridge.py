...
SLIDES = [
    ...
    },
    {
        ...
        "role": "method bridge",
        "status": "dark asset ready; B2 in notes",
        "tone": "sky",
        ...
        "asset": p("output/premium_methods_dark_variants_slides_4_5_v0_1/slide04_evaluation_layer_dark_rendered_preview.png"),
        "backup_assets": [
            p("output/premium_bridge_scenes/b1_evaluation_layer/rendered_preview.png"),
            p("output/premium_bridge_rebuild_scenes/b2_study_to_task_premium/rendered_preview.png"),
        ],
    },
    {
        "n": 5,
        ...
        "role": "method bridge",
        "status": "dark asset ready; B4 in notes",
        "tone": "sky",
        ...
        "asset": p("output/premium_methods_dark_variants_slides_4_5_v0_1/slide05_mission_heldout_dark_rendered_preview.png"),
        "backup_assets": [
            p("output/premium_bridge_rebuild_scenes/b3_mission_held_out_premium/rendered_preview.png"),
            p("output/premium_bridge_rebuild_scenes/b4_train_only_guard_premium/rendered_preview.png"),
        ],
    },
    {
        "n": 6,
...
def build() -> dict[str, str]:
    ...
    manifest = {
        ...
        "source_documents": [
            ...
            "output/premium_methods_dark_variants_slides_4_5_v0_1/slides_4_5_dark_methods_manifest.json",
    ...
    qa = {
        ...
        "manual_review": {
            "visual_review_status": "pass: assembly board and grayscale QA inspected with opening slides 1-3 and dark methods slides 4-5 integrated",
            ...
            "style_caution": "slides 4-5 dark methods variants are integrated for deck continuity; original light proof-stage scenes remain backup/source-proof assets",
        },
    }
