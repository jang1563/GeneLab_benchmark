#!/usr/bin/env python3
"""Build strict visual QA crops for the core-takeaway asset."""
...
SOURCE = ASSET_DIR / "core_benchmark_takeaway_premium.png"
...
def write_contact_sheet(crops: list[dict[str, object]], directory: Path, sheet_name: str) -> Path:
    ...
    for crop in crops:
        name = str(crop["name"])
        image = Image.open(directory / f"core_takeaway_{name}.png")
...
def crop_set(target_dir: Path, specs: list[dict[str, object]], sheet_name: str) -> Path:
    ...
    for spec in specs:
        ...
        out = target_dir / f"core_takeaway_{name}.png"
    ...
    (target_dir / "core_takeaway_crop_manifest.json").write_text(
...
def main() -> None:
    qa_specs = [
        ...
        {"name": "02_core_claim", "box": (120, 330, 1235, 1840)},
        {"name": "03_claim_status_cards", "box": (1225, 330, 2615, 1840)},
        {"name": "04_biology_bridge", "box": (2605, 330, 3730, 1840)},
    ...
    strict_specs = [
        ...
        {"name": "03_core_claim_top", "box": (150, 520, 1210, 930)},
        {"name": "04_core_claim_metrics", "box": (150, 930, 1210, 1215)},
        {"name": "05_result_spine", "box": (150, 1220, 1210, 1810)},
        {"name": "06_claim_cards_top", "box": (1260, 530, 2585, 1300)},
        {"name": "07_claim_cards_bottom", "box": (1260, 1305, 2585, 1810)},
        {"name": "08_bridge_top", "box": (2635, 520, 3700, 1100)},
        {"name": "09_bridge_bottom", "box": (2635, 1085, 3700, 1810)},
        {"name": "10_footer_source", "box": (130, 1870, 3710, 2100)},
    ]
    qa_sheet = crop_set(QA_DIR, qa_specs, "core_takeaway_qa_crop_contact_sheet.png")
    strict_sheet = crop_set(STRICT_DIR, strict_specs, "core_takeaway_STRICT_QA_contact_sheet.png")
