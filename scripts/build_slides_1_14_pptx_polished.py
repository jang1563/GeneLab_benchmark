#!/usr/bin/env python3
"""Build the slides 1-14 polished editable PPTX draft with artifact-tool.
...
CREATED = "2026-06-03"
THREAD_ID = os.environ.get("CODEX_THREAD_ID", "manual-20260603-slides-1-14-pptx-polish-v0-2")
TASK_SLUG = "spacebiobench-slides-1-14-pptx-polish"
...
PROJECT_OUTPUT_DIR = ROOT / "output" / "slides_1_14_pptx_polish_v0_2"
...
FINAL_PPTX = WORKSPACE_OUTPUT_DIR / "spacebiobench_slides_1_14_polished_v0_2.pptx"
CONTACT_SHEET = PREVIEW_DIR / "slides_1_14_polished_contact_sheet.png"
BUILD_MANIFEST = WORKSPACE_OUTPUT_DIR / "slides_1_14_polished_artifact_manifest.json"
...
def copy_final_deliverables(build_manifest: dict, deck_spec: list[dict]) -> dict:
    ...
    copied = {
        "pptx": PROJECT_OUTPUT_DIR / "spacebiobench_slides_1_14_polished_v0_2.pptx",
        "contact_sheet": PROJECT_OUTPUT_DIR / "slides_1_14_polished_contact_sheet.png",
        "artifact_manifest": PROJECT_OUTPUT_DIR / "slides_1_14_polished_artifact_manifest.json",
        "speaker_notes": PROJECT_OUTPUT_DIR / "slides_1_14_polished_speaker_notes.md",
    }
    ...
    note_lines = ["# Slides 1-14 Polished PPTX Speaker Notes", "", f"Date: {CREATED}", ""]
    for slide in deck_spec:
    ...
    production_manifest = {
        "created": CREATED,
        "artifact_role": "slides 1-14 polished editable PPTX draft",
        ...
        "qa_summary": {
            ...
            "polish_changes": "footer matte expanded, caveat/source text enlarged, slide-specific source lines corrected for slides 7-14",
            "known_status": "polished production draft, not final institutional-template deck",
        },
    }
    production_path = PROJECT_OUTPUT_DIR / "slides_1_14_polished_manifest.json"
